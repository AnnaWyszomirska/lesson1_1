...
class Contact:
    def __init__(self, firstname = None, middlename = None, lastname = None, nickname = None, title = None, company = None, address = None,
                 ...
                 bday= None, bmonth= None, aday= None, amonth= None, address2= None, privatephone= None, comments= None, id = None):
    ...
    def __eq__(self, other):
        return (self.id is None or other.id is None or self.id == other.id) and (self.firstname is None or other.firstname is None or

...
def test_contact_on_the_home_page(app, db):
    ...
    #assert contact_from_home_page.all_emails_form_home_page == merge_emails_like_on_homepage(contact_from_edit_page)
    ...
    #assert contact_from_home_page.firstname == contact_from_db.lastname
    #assert contact_from_home_page.firstname == contact_from_db.address
